...
def process_file(filename):
    ...
    tk = np.arange(12000)
    # k1.set_xscale('log')
    k1.plot(tk, spectrum(x)[0:12000])
    # k2.xscale('log')
    k2.plot(tk, spectrum(processed_x)[0:12000], color='g')
    # k3.xscale('log')
    k3.plot(tk, spectrum(null_test_signal)[0:12000], color='r')
    ...
    return null_test_filename, processed_filename
